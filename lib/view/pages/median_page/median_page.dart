...
class MedianPage extends StatefulWidget {
  MedianPage({Key? key}) : super(key: key);

  @override
  State<MedianPage> createState() => _MedianPageState();
}

class _MedianPageState extends State<MedianPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: Strings.medianTitle,
        description: Strings.mainDescription,
        imagePath: Strings.medianImagePath,
      ),
            ...
            Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      result = Calculate.medianResult(_valueList);
                      setState(() {});
                      showDialog(
                          context: context,
